...
export class CustomerCounterOfferController extends BaseController {
  ...
  protected async executeImpl(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    const customOrder = await this.customOrderService.customerCounterOffer(
      id,
      req.user!.id,
      req.body,
    );

    ApiResponse.success(res, customOrder, 'Counter offer sent successfully');
  }
}
