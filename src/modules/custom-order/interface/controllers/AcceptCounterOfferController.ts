...
export class AcceptCounterOfferController extends BaseController {
  ...
  protected async executeImpl(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    const customOrder = await this.customOrderService.acceptCounterOffer(id, req.user!.id);

    ApiResponse.success(res, customOrder, 'Counter offer accepted successfully');
  }
}
