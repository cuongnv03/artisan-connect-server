...
export class CustomerRejectOfferController extends BaseController {
  ...
  protected async executeImpl(req: Request, res: Response, next: NextFunction): Promise<void> {
    ...
    const customOrder = await this.customOrderService.customerRejectOffer(
      id,
      req.user!.id,
      req.body,
    );

    ApiResponse.success(res, customOrder, 'Offer rejected successfully');
  }
}
