...
import {
  ...
  AddToCartDto,
  UpdateCartItemDto,
} from '../../../modules/cart/domain/entities/CartItem';
import { ICartRepository } from '../../../modules/cart/domain/repositories/CartRepository.interface';
import { IProductRepository } from '../../product/domain/repositories/ProductRepository.interface';
import { IUserRepository } from '../../../modules/user/domain/repositories/UserRepository.interface';
