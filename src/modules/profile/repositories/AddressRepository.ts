  ...
  implements IAddressRepository
{
  ...
  async getAddressesByProfileId(profileId: string): Promise<Address[]> {
    try {
      ...
      throw new AppError('Failed to get addresses', 500, 'DATABASE_ERROR');
    }
  }
  ...
  async createAddress(profileId: string, data: CreateAddressDto): Promise<Address> {
    try {
      ...
      throw new AppError('Failed to create address', 500, 'DATABASE_ERROR');
    }
  }
  ...
  async updateAddress(id: string, data: UpdateAddressDto): Promise<Address> {
    try {
      ...
      if (error instanceof AppError) throw error;
      throw new AppError('Failed to update address', 500, 'DATABASE_ERROR');
    }
  }
  ...
  async setAsDefault(id: string, profileId: string): Promise<Address> {
    try {
      ...
      throw new AppError('Failed to set address as default', 500, 'DATABASE_ERROR');
    }
  }
