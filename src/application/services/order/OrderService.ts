...
export class OrderService implements IOrderService {
  ...
  async createOrderFromCart(
    ...
    try {
      ...
      return await this.orderRepository.createOrderFromCart(userId, data);
    } catch (error) {
  ...
  async createOrderFromQuote(
    ...
    try {
      ...
      return await this.orderRepository.createOrderFromQuote(userId, data);
    } catch (error) {
  ...
  async cancelOrder(id: string, userId: string, note?: string): Promise<OrderWithDetails> {
    try {
      ...
      return await this.orderRepository.cancelOrder(id, note, userId);
    } catch (error) {
